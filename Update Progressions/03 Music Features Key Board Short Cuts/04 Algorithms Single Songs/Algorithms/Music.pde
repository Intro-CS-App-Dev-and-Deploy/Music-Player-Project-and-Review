...
AudioPlayer songs; //Computer Numbering, not human numbering
...
void musicLoadSetup() {
  ...
  //
  songs = minim.loadFile( musicPathway + fslash + groove + dereferencer + fileExtension ); //able to pass absolute path, file name & extension, and URL
